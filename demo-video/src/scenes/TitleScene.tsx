...
export const TitleScene: React.FC = () => {
  ...
  const glow = interpolate(frame, [0, 60], [0.35, 0.75], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
    ...
    <AbsoluteFill style={{ alignItems: 'center', justifyContent: 'center', fontFamily: FONT }}>
      <div
        style={{
          ...
          height: 1400,
          borderRadius: '50%',
          background: `radial-gradient(circle, ${C.accent}33 0%, transparent 62%)`,
          opacity: glow,
        }}
      />
      <div style={{ transform: `scale(${0.85 + pop * 0.15})`, opacity: pop, textAlign: 'center' }}>
        <div style={{ fontSize: 128, fontWeight: 800, color: C.text, letterSpacing: -3 }}>
        ...
        <div style={{ fontSize: 42, fontWeight: 500, color: C.textDim, opacity: subOpacity }}>
          2D floor plan&nbsp;&nbsp;→&nbsp;&nbsp;living, editable 3D home
        </div>
        <div style={{ fontSize: 28, fontWeight: 500, color: C.textFaint, opacity: subOpacity, marginTop: 18 }}>
